...
import { AlertCircle, CreditCard, Package, X } from 'lucide-react'
		...
		<div className="container mx-auto px-3 sm:px-4 py-8 sm:py-16">
			<div className="max-w-4xl mx-auto">
				<div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
					<div className="bg-gradient-to-r from-red-500 to-orange-600 p-6 sm:p-8 text-white text-center">
						...
						<h1 className="text-2xl sm:text-4xl font-bold mb-3 sm:mb-4">Оплата не прошла</h1>
					...
					<div className="p-4 sm:p-8">
						{loading && (
							<div className="text-center py-8 sm:py-12">
								<div className="inline-block animate-spin rounded-full h-10 w-10 sm:h-12 sm:w-12 border-t-2 border-b-2 border-red-500"></div>
							...
							<>
								<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
									...
									<div className="bg-gray-50 p-4 sm:p-6 rounded-xl">
										...
										<p className="text-xs sm:text-sm text-gray-500 mt-1">Оплата не завершена</p>
									</div>
								...
								<div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
									<div className="flex items-start gap-3 sm:gap-4">
										...
										<div>
											<h3 className="font-bold text-yellow-800 text-base sm:text-lg mb-2">Что делать дальше?</h3>
											<ul className="list-disc pl-5 text-yellow-700 space-y-1 text-sm sm:text-base">
												<li>Проверьте правильность введенных данных карты (номер, срок действия, CVC).</li>
												<li>Убедитесь, что на карте достаточно средств.</li>
												<li>Попробуйте использовать другую карту или способ оплаты.</li>
												<li>Если проблема повторяется, свяжитесь с вашим банком.</li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div className="space-y-4">
									<p className="text-gray-600 text-center text-sm sm:text-base">
										Вы можете вернуться в корзину и попробовать оплатить заказ еще раз.
									</p>
						...
						<p className="mt-6 sm:mt-8 text-xs sm:text-sm text-gray-500 text-center">Если проблема повторяется, свяжитесь с нашей поддержкой.</p>
					</div>
				</div>
			</div>
		</div>
