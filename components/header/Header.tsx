		...
		<>
			<header className="hidden px-20 py-10 lg:flex items-center justify-between bg-white sticky top-0 z-50 shadow-md">
				...
				<div className="flex items-center gap-2">
					...
					/>
					<button
						className="flex items-center justify-center rounded-lg bg-gradient-to-t from-[#0d65df] from-0% to-[#0752c2] to-100% p-1.5 text-white hover:bg-blue-900"
				...
				<div className="flex items-center gap-5">
					{openCart ? (
						...
						>
							<div
								className="bg-red-700 text-white rounded-[50%] text-[10px] font-medium flex items-center justify-center absolute top-[-5px] right-[-5px] min-w-[16px]"
								id="counter-cart"
								aria-hidden="true"
							>
