...
const MobileSearchInput = forwardRef<HTMLInputElement, MobileSearchInputProps>(
	(
		...
		return (
			<form
				className={`relative mb-2 mt-3 rounded-xl w-full focus-within:border focus-within:border-blue-200 shadow-lg ${className}`}
				id="search"
			...
			>
				...
				<div className="absolute flex items-center gap-2 top-[50%] translate-y-[-50%] right-2.5">
					...
					<button
						type="submit"
						className="flex items-center justify-center rounded-lg bg-blue-900 p-1.5 bg-gradient-to-t from-[#0d65df] from-0% to-[#0752c2] to-100%"
