...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const variantClasses = {
            // ИЗМЕНЕНО: Синий градиент заменен на зеленый фирменный цвет
            primary: 'bg-[#0f6b46] text-white hover:bg-[#0a4e32] hover:shadow-green-300 bg-gradient-to-t from-[#0a4e32] from-0% to-[#0f6b46] to-100% ',
            secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300',
            outline: 'border-2 border-[#0f6b46] text-[#0f6b46] bg-transparent hover:bg-green-50',
