								...
								{items.map(item => (
									...
									>
										...
										<div className="flex-1 min-w-0">
											...
											>
												<h3
													className="text-sm font-medium text-gray-900 mb-1 truncate hover:text-blue-600 transition-colors"
													title={item.title}
												>
													{item.title}
												</h3>
											...
											<p className="text-sm font-bold text-red-500 mb-2">{item.price} ₽</p>
